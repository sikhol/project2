  ...
  <div class="container-fluid">
	...
	<div class="container" style="border: 0px;  background-color: #faffff;border-radius: 5px; opacity: .95; min-height: 600px;"s>
		<div class="row">
            ...
            <h3 style="text-align: center; color:white; font-size: 35px; ">Data ruangan </h3>
        </div>
 ...
 <!--  <h2 style="text-align: center; margin-bottom: 70px;">Data Pasien Terdaftar</h2> -->
  ...
  <table class="table">
    ...
    <tbody>
      ...
      <tr>
       <td>
				<a href="ubahruang.php?id=<?= $row["kd_ruang"]; ?>">ubah</a> |
				<a href="hapusruang.php?id=<?= $row["kd_ruang"]; ?>">hapus</a>
			</td>
